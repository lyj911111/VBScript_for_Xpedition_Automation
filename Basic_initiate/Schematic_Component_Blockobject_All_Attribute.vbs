...
For Each oComp In colComps
	...
	If Not oBlockRefdes Is Nothing Then
		...
		If msgbox("unique id : " & oComp.uid & chr(13) &_
                  oBlockRefdes.name & " : " & oBlockRefdes.Value & chr(13) &_
                  oBlockPartName.name & " : " & oBlockPartName.Value & chr(13) &_
                  oBlockPartNumber.name & " : " & oBlockPartNumber.Value & chr(13) &_
                  oBlockCellName.name & " : " & oBlockCellName.Value & chr(13) &_
                  oBlockPartLabel.name & " : " & oBlockPartLabel.Value,_
                   vbYesNo, "" ) = vbNo Then
            Exit For
		End If
	End If
